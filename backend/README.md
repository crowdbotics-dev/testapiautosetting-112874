...
## Project Structure
    ...
    ├── testapiautosetting_112874  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_112874`
...
2. Clone this repo and `cd testapiautosetting_112874`
